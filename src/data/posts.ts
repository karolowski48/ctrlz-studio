...
export const posts: Post[] = [
  {
    ...
    featured: false,
    bg: 'linear-gradient(135deg,#0d0a2e 0%,#241a5c 50%,#080618 100%)',
    glowColor: 'rgba(124,107,255,.45)',
  },
  {
    slug: 'akt-o-dostepnosci-sklep-internetowy',
    title: 'Akt o dostępności — co musi zmienić sklep internetowy',
    excerpt: 'Od 28 czerwca 2025 sklepy internetowe muszą być dostępne dla osób z niepełnosprawnościami. Kogo to dotyczy, kto jest zwolniony i co grozi za brak zgodności.',
    cat: 'E-commerce',
    time: '9 min',
    date: '18 września 2026',
    featured: false,
    bg: 'linear-gradient(135deg,#04202b 0%,#0b4a5e 50%,#02121a 100%)',
    glowColor: 'rgba(56,189,248,.45)',
  },
  {
    slug: 'seo-czy-google-ads-maly-budzet',
    title: 'SEO czy Google Ads — od czego zacząć przy małym budżecie',
    excerpt: 'Porównanie kosztów, terminów i ryzyka. Kiedy reklamy mają sens, kiedy SEO, a kiedy nie warto robić żadnego z nich — i dlaczego kolejność bywa inna, niż się wydaje.',
    cat: 'SEO',
    time: '10 min',
  ...
  {
    slug: 'ile-trwa-odzyskanie-pozycji-w-google',
    title: 'Ile trwa odzyskanie pozycji w Google po ataku, migracji albo nowej stronie',
    excerpt: 'Realne terminy dla trzech scenariuszy, na danych z naszej własnej domeny. Co przyspiesza powrót, co go blokuje i po czym poznać, że idzie w dobrą stronę.',
    cat: 'SEO',
    time: '10 min',
  ...
  {
    slug: 'przeniesienie-strony-na-inny-hosting',
    title: 'Jak przenieść stronę na inny hosting bez utraty pozycji w Google',
    excerpt: 'Kiedy warto zmienić hosting, jak przebiega migracja i co sprawdzić po przełączeniu domeny. Plus pięć błędów, które kończą się weekendem bez strony.',
    cat: 'Technologie',
    time: '9 min',
  ...
  {
    slug: 'jak-sprawdzic-czy-strona-jest-zainfekowana',
    title: 'Jak sprawdzić, czy strona jest zainfekowana — 8 sygnałów',
    excerpt: 'Osiem rzeczy do sprawdzenia w kwadrans, bez wiedzy technicznej. Co widać w Google, co w Search Console, a co dopiero po zajrzeniu na serwer.',
    cat: 'Technologie',
    time: '9 min',
  ...
  {
    slug: 'zawirusowana-strona-wordpress',
    title: 'Zawirusowana strona WordPress — jak wygląda odzyskiwanie i ile to trwa',
    excerpt: 'Nasza własna historia: 75 tysięcy śmieciowych adresów w Google po ataku. Co dokładnie robiliśmy, ile to trwało i czego nauczyliśmy się po drodze.',
    cat: 'Technologie',
    time: '12 min',
    date: '1 września 2026',
    featured: true,
    bg: 'linear-gradient(135deg,#2a0808 0%,#5c1414 50%,#1c0505 100%)',
    glowColor: 'rgba(248,113,113,.45)',
  },
  {
    slug: 'nowa-strona-czy-przebudowa',
    title: 'Nowa strona czy przebudowa obecnej? Jak policzyć, co się bardziej opłaca',
    excerpt: 'Sześć pytań, które rozstrzygają, czy naprawa istniejącej strony ma sens — plus element, który przy wymianie decyduje o utrzymaniu pozycji w Google.',
    cat: 'Biznes',
    time: '10 min',
  ...
  {
    slug: 'strona-internetowa-dla-firmy-z-wadowic',
    title: 'Strona internetowa dla firmy z Wadowic — co powinna mieć, żeby zdobywać klientów',
    excerpt: 'Dziewięć elementów decydujących o liczbie zapytań i pięć rzeczy, za które szkoda płacić. Poradnik dla firm z Wadowic, Andrychowa i powiatu.',
    cat: 'Biznes',
    time: '11 min',
  ...
  {
    slug: 'ile-kosztuje-strona-internetowa-wadowice',
    title: 'Ile kosztuje strona internetowa w Wadowicach? Cennik i przykładowe koszty',
    excerpt: 'Widełki dla firm z powiatu, trzy przykładowe wyceny z realnych projektów i koszty utrzymania, o których nie mówi się przy podpisywaniu umowy.',
    cat: 'Biznes',
    time: '10 min',
